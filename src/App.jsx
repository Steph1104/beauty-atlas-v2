  ...
  return (
    <div style={{borderBottom:"1px solid rgba(196,168,130,0.2)",padding:"16px 32px",display:"flex",alignItems:"center",justifyContent:"space-between",background:"#faf7f4",position:"sticky",top:0,zIndex:100}}>
      <button onClick={onLogoClick} style={{background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:12}}>
        <span style={{fontFamily:"'Playfair Display',serif",fontSize:20,fontWeight:400,color:"#582216",letterSpacing:6,textTransform:"uppercase"}}>Beauty</span>
...
function ProductCard({ tab, data, countryName, flag }) {
  ...
  return (
    <div style={{padding:"24px 0"}}>
      ...
      <h3 style={{fontFamily:"'Playfair Display',serif",fontSize:20,fontWeight:400,color:"",marginBottom:4}}>{d.product}</h3>
        ...
        {selectedCountry ? (
          <div style={{maxWidth:720,margin:"0 auto"}}>
            ...
            <div style={{display:"flex",alignItems:"flex-start",gap:16,marginBottom:28}}>
              ...
              <div>
                <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,5vw,44px)",fontWeight:400,color:"",letterSpacing:4,textTransform:"uppercase"}}>{selectedCountry.name}</h1>
            ...
            <div style={{display:"flex",gap:0,borderBottom:"1px solid rgba(196,168,130,0.25)",marginBottom:28,overflowX:"auto"}}>
              {beautyTabs.map(t => (
                <button key={t.id} className="tab-btn" onClick={() => setActiveTab(t.id)}
                  style={{color:activeTab===t.id?"":"#8b7355",borderBottom:activeTab===t.id?"2px solid #c4a882":"2px solid transparent",fontSize:11,letterSpacing:3,whiteSpace:"nowrap"}}>
                  {t.icon} {t.label}
                </button>
              ))}
            </div>
          ...
          <>
            <div style={{marginBottom:32,textAlign:"center"}}>
              <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(24px,4vw,38px)",fontWeight:400,color:"",letterSpacing:8,textTransform:"uppercase",marginBottom:8}}>Explore the Atlas</h1>
              ...
              {filtered.map(country => (
                <div key={country.name} className="country-card" onClick={() => { setSelectedCountry(country); setActiveTab("skincare"); }} style={{padding:"24px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14}}>
                    ...
                    <div>
                      <div style={{fontFamily:"'Playfair Display',serif",fontSize:18,fontWeight:400,color:"",letterSpacing:2}}>{country.name}</div>
        ...
        {selected && data ? (
          <>
            ...
            <div style={{marginBottom:32}}>
              ...
              <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(24px,4vw,36px)",fontWeight:400,color:"",letterSpacing:4,textTransform:"uppercase",marginBottom:8}}>{data.label}</h1>
              ...
              {data.countries.map((c, i) => (
                <div key={i} style={{background:"#fff",border:"1px solid rgba(196,168,130,0.2)",padding:"28px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}>
                    ...
                    <div>
                      <div style={{fontFamily:"'Playfair Display',serif",fontSize:16,color:"",letterSpacing:2}}>{c.country}</div>
                  ...
                  <h3 style={{fontFamily:"'Playfair Display',serif",fontSize:18,fontWeight:400,color:"",marginBottom:12}}>{c.product}</h3>
          ...
          <>
            <div style={{textAlign:"center",marginBottom:36}}>
              <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(24px,4vw,38px)",fontWeight:400,color:"",letterSpacing:8,textTransform:"uppercase",marginBottom:8}}>My Skin Concern</h1>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:16}}>
              {skinConcerns.map(c => (
                <div key={c.id} className="concern-card" onClick={() => setSelected(c)}>
                  ...
                  <div style={{fontFamily:"'Playfair Display',serif",fontSize:17,fontWeight:400,color:"",marginBottom:6,letterSpacing:1}}>{c.label}</div>
...
function LandingScreen({ onEnter }) {
  const floatingFlags = ["🇰🇷","🇫🇷","🇯🇵","🇧🇷","🇮🇳","🇲🇦","🇺🇸","🇸🇪","🇳🇬","🇦🇺","🇪🇬","🇮🇹","🇹🇭","🇨🇴","🇪🇹","🇬🇷","🇨🇳","🇬🇭","🇦🇷"];
  return (
    <div style={{minHeight:"100vh",background:"",display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden"}}>
      <style>{css}</style>
      <style>{`
  ...
  return (
    <div style={{minHeight:"100vh",background:"#faf7f4"}}>
      ...
      <div style={{maxWidth:720,margin:"0 auto",padding:"48px 24px"}}>
        ...
        <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,5vw,42px)",fontWeight:400,color:"",letterSpacing:4,textTransform:"uppercase",marginBottom:8}}>Privacy Policy</h1>
        ...
        {[
          ...
          <div key={title} style={{marginBottom:32}}>
            <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:18,fontWeight:400,color:"",letterSpacing:2,marginBottom:10}}>{title}</h2>
...
function TermsOfUse({ onBack }) {
  return (
    <div style={{minHeight:"100vh",background:"#faf7f4"}}>
      ...
      <div style={{maxWidth:720,margin:"0 auto",padding:"48px 24px"}}>
        <button className="back-btn" onClick={onBack} style={{marginBottom:32}}>← Back</button>
        <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,5vw,42px)",fontWeight:400,color:"",letterSpacing:4,textTransform:"uppercase",marginBottom:8}}>Terms of Use</h1>
        <p style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:15,color:"#8b7355",marginBottom:40}}>Last updated: {new Date().toLocaleDateString('en-US', {year:'numeric',month:'long',day:'numeric'})}</p>
